...
- Jellyfin `12`. For Jellyfin `10.11.x`, use plugin release `1.2.2.0` from the `jellyfin-10.11` branch.
...
```powershell
.\scripts\package.ps1 -Version 2.0.1.0
```

Create a local release ZIP on Linux/macOS:

```bash
bash ./scripts/package.sh 2.0.1.0
```
